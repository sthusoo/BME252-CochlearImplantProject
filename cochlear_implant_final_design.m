...
filteredChan = zeros(numChan, length(downsampled_y)); %create array for filtered channels
...
%Task 6
    ...
    if i == numChan
        %Highest Frequency Channel Plots for Filtered IIR signal
...
outputSig = outputSig/maxAbsSig; %normalize the output signal by its max val
